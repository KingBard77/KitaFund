...
<div class='main-panel'>
    <div class='content-wrapper'>
        ...
        function load_data(initial_date, final_date, Action_Name) {
            var ajax_url = "../Database/Record/Attendance/fetch_attendance.php";
        ...
        $(document).on('submit', '#updateUser', function(e) {
            ...
            if (Employee_Code != '' && Action_Name != '' && Attendance_Time != '' && Attendance_Message != '') {
                $.ajax({
                    url: "../Database/Record/Attendance/update_attendance.php",
                    type: "post",
                    data: {
                    ...
                    success: function(data) {
                        ...
                        alert("You have update for the Application Attendance, Thank You");
                        if (status == 'true') {
        ...
        $('#records').on('click', '.editbtn ', function(event) {
            ...
            $.ajax({
                url: "../Database/Record/Attendance/single_data_attendance.php",
                data: {
                    id: id
                },
                type: 'post',
        ...
        $(document).on('click', '.deleteBtn', function(event) {
            ...
            if (confirm("Are you sure want to delete this User ? ")) {
                $.ajax({
                    url: "../Database/Record/Attendance/delete_attendance.php",
                    data: {
                        id: id
                    },
                    type: "post",
        ...
        $(document).on('submit', '#addUser', function(e) {
            ...
            if (Employee_Code != '' && Action_Name != '' && Attendance_Message != '') {
                $.ajax({
                    url: "../Database/Record/Attendance/add_attendance.php",
                    type: "post",
                    data: {
                        Attendance_Message: Attendance_Message,
                        Action_Name: Action_Name,
                    ...
                    success: function(data) {
                        var json = JSON.parse(data);
                        var status = json.status;
                        alert("You have apply for the Application Attendance, Thank You");
                        if (status == 'true') {
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" id="AttendanceMessageField"
                                        name="Attendance_Message" placeholder="Sorry for late">
                                </div>
                            </div>
