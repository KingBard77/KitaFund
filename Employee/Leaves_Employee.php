...
<div class='main-panel'>
    <div class='content-wrapper'>
        ...
        function load_data(initial_date, final_date, Leave_Status) {
            var ajax_url = "../Database/Record/Leaves/fetch_leaves.php";
        ...
        $(document).on('submit', '#updateUser', function(e) {
            ...
            if (Employee_Code != '' && Leave_Type != '' && From_Date != '' && To_Date != '' &&
                Leave_Message != '' && Leave_Status != '' && Apply_Date != '') {
                $.ajax({
                    url: "../Database/Record/Leaves/update_leaves.php",
                    type: "post",
                    data: {
                    ...
                    success: function(data) {
                        ...
                        alert("You have update for the Application Leave, Thank You");
                        if (status == 'true') {
        ...
        $('#records').on('click', '.editbtn ', function(event) {
            ...
            $.ajax({
                url: "../Database/Record/Leaves/single_leaves_data.php",
                data: {
                    id: id
                },
                type: 'post',
        ...
        $(document).on('click', '.deleteBtn', function(event) {
            ...
            if (confirm("Are you sure want to delete this User ? ")) {
                $.ajax({
                    url: "../Database/Record/Leaves/delete_leaves.php",
                    data: {
                        id: id
                    },
                    type: "post",
        ...
        $(document).on('submit', '#addUser', function(e) {
            ...
            if (Employee_Code != '' && Leave_Type != '' && From_Date != '' && To_Date != '' &&
                Leave_Message != '' && Leave_Status != '') {
                $.ajax({
                    url: "../Database/Record/Leaves/add_leaves.php",
                    type: "post",
                    data: {
                    ...
                    success: function(data) {
                        var json = JSON.parse(data);
                        var status = json.status;
                        alert("You have apply for the Application Leave, Thank You");
                        if (status == 'true') {
                    ...
                    <div class="modal-body">
                        <form id="updateUser">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" id="LeaveMessageField"
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" id="LeaveStatusField" name="Leave_Status"
                                        disabled>
                                </div>
                            </div>
                            <div class="mb-3 row">
                    ...
                    <div class="modal-body">
                        <form id="addUser" action="">
                            ...
                            <div class="mb-3 row">
                                <label class="col-sm-3 col-form-label">Status</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" id="AddLeaveStatusField" name="Leave_Status"
