    ...
    <div class="container-scroller">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo mr-5" href="Dashboard.php"><img src="../Images/KitaFund_Logo.png"
                        class="mr-2" alt="logo" /></a>
                <a class="navbar-brand brand-logo-mini" href="Dashboard.php"><img src="../Images/KitaFund_Icon.png"
                        alt="logo" /></a>
            </div>
                ...
                <ul class="navbar-nav navbar-nav-right">
                    ...
                    <li class="nav-item nav-profile dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown"
                            ...
                            <a class="dropdown-item" href="Logout_Adminstrator.php">
