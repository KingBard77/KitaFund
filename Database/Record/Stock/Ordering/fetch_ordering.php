...
if($_REQUEST['action'] == 'fetch_ordering'){
    ...
    $where = " WHERE employee.Employee_Code ='$emp_code' ".$date_range.$Order_Status;
    ...
    while($row = mysqli_fetch_array($result)){
        ...
        <div class="col text-center">
            <a href="javascript:void();" data-id="'.$row['Order_Id'].'"  class="btn btn-outline-primary btn-sm editbtn" >View</a>  
