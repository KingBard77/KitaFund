...
<div class='main-panel'>
    <div class='content-wrapper'>
        ...
        function load_data(initial_date, final_date, Order_Status) {
            var ajax_url = "../Database/Stock/Ordering/fetch_ordering.php";
        ...
        $(document).on('submit', '#updateUser', function(e) {
            e.preventDefault();
            var Order_Date = $('#OrderDateField').val();
            var Order_Status = $('#OrderStatusField').val();
            var trid = $('#trid').val();
            var id = $('#id').val();
            if (Order_Status != '' && Order_Date != '') {
                $.ajax({
                    url: "../Database/Stock/Ordering/update_ordering.php",
                    type: "post",
                    data: {
                    ...
                    success: function(data) {
                        ...
                        alert("You have update for Raw Materials Ordering, Thank You");
                        if (status == 'true') {
        ...
        $('#records').on('click', '.editbtn ', function(event) {
            ...
            $.ajax({
                url: "../Database/Stock/Ordering/single_data_ordering.php",
                data: {
                    id: id
                },
                type: 'post',
            ...
            $.ajax({
                url: "../Database/Stock/Ordering/ordering_receipt.php?id="+id,
                type: 'get',
                success: function(data) {
        ...
        <!-- UPDATE ORDERING MODAL -->
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Update Raw Material Ordering</h5>
                    ...
                    <div class="modal-body">
                        <form id="updateUser">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control" name="Order_Status" id="OrderStatusField">
                                        <option value="">- Please Select Order Status -</option>
                                        <option value="Purchase">Purchase</option>
                                        <option value="Pending">Pending</option>
                                    </select>
